...
def max_value(lahsa_pool, spla_pool, lahsa_current, spla_current, ap, a, b):  
    ...
    for i in range(len(spla_pool)):
        ...
        #spla_current.output_current()    
        #recursive
        tem = min_value(buffer_lahsa_pool, buffer_spla_pool, lahsa_current, spla_current, ap, a, b)
        if (v[0] < tem[0]):
            v = tem
            v[1].append(key)
        #recursive
...
def min_value(lahsa_pool, spla_pool, lahsa_current, spla_current, ap, a, b):
    ...
    for i in range(len(lahsa_pool)):
        ...
        tem = max_value(buffer_lahsa_pool, buffer_spla_pool, lahsa_current, spla_current, ap, a ,b)
        if (v[0] > tem[0]):
            v = tem
            v[1].append('&'+key)
        #recursive
        ...
        #lahsa_current.output_current()
    if (v[0] == int(1e9)):
        return max_value(lahsa_pool, spla_pool, lahsa_current, spla_current, ap, a, b)
    else:
        return v
...
output = max_value(lahsa_pool, spla_pool, lahsa_current, spla_current, ap, -1e9, 1e9)
#print "output: ", output
